...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_upload_upload_file_service__ = __webpack_require__("../../../../../src/app/components/upload/upload-file.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__layouts_simple_layout_component__ = __webpack_require__("../../../../../src/app/layouts/simple-layout.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_login_component__ = __webpack_require__("../../../../../src/app/pages/login.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10_ng2_charts_ng2_charts__["ChartsModule"], __WEBPACK_IMPORTED_MODULE_4__angular_http__["b" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_5__angular_common_http__["b" /* HttpClientModule */]
            ],
            declarations: [
                __WEBPACK_IMPORTED_MODULE_19__pages_login_component__["a" /* LoginComponent */],
                __WEBPACK_IMPORTED_MODULE_6__app_component__["a" /* AppComponent */],
                __WEBPACK_IMPORTED_MODULE_17__layouts_full_layout_component__["a" /* FullLayoutComponent */],
                __WEBPACK_IMPORTED_MODULE_18__layouts_simple_layout_component__["a" /* SimpleLayoutComponent */],
            ...
            providers: [{
                ...
                }, __WEBPACK_IMPORTED_MODULE_15__data_service__["a" /* DataService */], __WEBPACK_IMPORTED_MODULE_16__components_upload_upload_file_service__["a" /* UploadFileService */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_login_component__ = __webpack_require__("../../../../../src/app/pages/login.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    {
        path: 'login',
        component: __WEBPACK_IMPORTED_MODULE_4__pages_login_component__["a" /* LoginComponent */],
        data: {
            title: 'Login Page'
        }
    },
...
var UploadFileService = (function () {
    ...
    UploadFileService.prototype.pushFileToStorage = function (file, url) {
        var formdata = new FormData();
        formdata.append('file', file);
        var req = new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpRequest */]('POST', url, formdata, {
            reportProgress: true,
            responseType: 'text'
        });
...
var DataService = (function () {
    ...
    DataService.prototype.getUser = function (name, password) {
    ...
    DataService.prototype.getPostData = function (url, bodyParam) {
        return this.http.post(url, bodyParam)
            .map(function (res) { return res.json(); });
    };
    DataService.prototype.getBranch = function () {
        return this.branch;
    };
    DataService.prototype.setBranch = function (branch) {
        this.branch = branch;
    };
...
module.exports = "<div class=\"app flex-row align-items-center\">\n  <div class=\"container\">\n    <div class=\"row justify-content-center\">\n      <div class=\"col-md-8\">\n        <div class=\"card-group mb-0\">\n          <div class=\"card p-4\">\n            <div class=\"card-body\" >\n              <h1>&nbsp;</h1>\n              <p class=\"text-muted\">Sign In to your account</p>\n              <div class=\"input-group mb-3\">\n                <span class=\"input-group-addon\"><i class=\"icon-user\"></i></span>\n                <input type=\"text\" [(ngModel)]=\"name\" class=\"form-control\" placeholder=\"Username\"> \n              </div>\n              <div class=\"input-group mb-4\">\n                <span class=\"input-group-addon\"><i class=\"icon-lock\"></i></span>\n                <input type=\"password\" [(ngModel)]=\"password\" class=\"form-control\" placeholder=\"Password\">\n              </div>\n              <div class=\"row\">\n                <div class=\"col-6\">\n                 \n                  <button type=\"button\" class=\"btn btn-primary px-4\" (click)=\"loadUser()\">Login</button>\n                </div>\n                <div class=\"col-6 text-right\">\n                  <button type=\"button\" class=\"btn btn-link px-0\">Forgot password?</button>\n                </div>\n              </div>\n            </div>\n          </div>\n          <div class=\"card text-white bg-primary py-5 d-md-down-none\" style=\"width:44%\">\n            <div class=\"card-body text-center\">\n              <div>\n                <img src=\"http://kabani.co.in/assets/images/logo.png\"/>\n                <h2>Our Goals</h2>\n                \n                <p style=\"font-size: 10px;\">\n\n\nRegional expansion of soap manufacturing and marketing and develop a strong base of key customers. Increase the assets and investments of the company to support the development of services. To build good reputation in the field of soap manufacturing and marketing and become a key player in the industry..\n</p>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.loadUser = function () {
        var _this = this;
        var link = ['/dashboard'];
        this.dataService.getUser(this.name, this.password).subscribe(function (data) {
            if (data) {
                _this.dataService.setBranch(_this.name);
